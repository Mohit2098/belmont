...
class SLP_Experience extends SLP_BaseClass_Addon {
	...
	function add_hooks_and_filters() {
		...
		add_filter( 'slp-power-csvexport', array( $this, 'filter_Locations_Export_Data' ), 90 );
	}
	 ...
	 */
	public function filter_Locations_Export_Data( $location ) {
	...
	public function select_cities_in_state( $command ) {
		if ( $command !== 'select_cities_in_state' ) {
			return $command;
		}
