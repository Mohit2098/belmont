...
class SLP_Text extends SLP_Object_With_Objects {
	...
	private function init_strings( $slug ) {
		...
		switch ( $area_slug ) {
			...
			case 'description':
				$this->text_strings[ $area_slug ]['google_geocode_key'] = __( 'The Google API key used for back-end geocoding of locations. ', 'store-locator-le' ) . __( 'It is a good idea to set an IP address restriction that matches your server IP address. ', 'store-locator-le' );
				...
				$this->text_strings[ $area_slug ]['hide_address_entry']   = __( 'Hide the address input box on the locator search form.', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['hide_radius_selector'] = __( 'Hide the radius selection drop down.', 'store-locator-le' );

				$this->text_strings[ $area_slug ]['premium_user_id']         = __( 'Your Premier User ID. ', 'store-locator-le' ) . $extra_help;
				$this->text_strings[ $area_slug ]['premium_subscription_id'] = __( 'Your Premier Subscription ID. ', 'store-locator-le' ) . $extra_help;
			...
			case 'label':
				...
				$this->text_strings[ $area_slug ]['hide_address_entry']      = __( 'Hide Address Entry', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['hide_radius_selector']    = __( 'Hide Radius Selections', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['plugin_style']            = __( 'Plugin Style', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['premium_subscription_id'] = __( 'Premier Subscription ID ', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['premium_user_id']         = __( 'Premier User ID', 'store-locator-le' );
			...
			case 'option_default':
				...
				$this->text_strings[ $area_slug ]['first_entry_for_radius_selector'] = '';
				$this->text_strings[ $area_slug ]['label_for_name']                  = __( 'Store Name', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['name_placeholder']                = '';
				$this->text_strings[ $area_slug ]['search_box_title']                = '';
				break;
			...
			case 'settings_group_header':
				...
				$this->text_strings[ $area_slug ]['appearance_no_results']    = __( 'Appearance - No Results', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['data']                     = __( 'Extended Data', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['experience']               = __( 'Experience', 'store-locator-le' );
				...
				$this->text_strings[ $area_slug ]['packaged_data_extensions'] = __( 'Extended Data', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['power']                    = __( 'Power', 'store-locator-le' );
				$this->text_strings[ $area_slug ]['results_interaction']      = __( 'Results Interaction', 'store-locator-le' );
			...
			case 'settings_section':
				...
				$this->text_strings[ $area_slug ]['server']         = __( 'App', 'store-locator-le' );
