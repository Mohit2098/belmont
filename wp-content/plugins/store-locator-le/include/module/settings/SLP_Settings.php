            ...
            <div class='dashboard-main store-locator-plus'>
                <section class='dashboard-content'>
                    <div id='wpcsl_container'
                         class='settings_page page_<?php echo wp_kses( $this->current_admin_page, 'strip' ) ?>'>
                        <form method='post'
                              action='<?php echo wp_kses( $this->form_action, 'strip' ) ?>'
                              class='slplus_settings_form'
							<?php echo wp_kses_post( $form_id ); ?>
							<?php echo wp_kses_post( $form_name ); ?>
							<?php echo wp_kses_post( $form_enc ); ?>
                        >
                                    ...
                                    <ul class="sub-navbar">
										...
										foreach ( $this->sections as $section ) {
											if ( $section->auto ) {
												...
												print wp_kses_post( "<li class='top-level general {$firstClass} navbar-item'>" . sprintf( "<a id='%s_sidemenu' class='navbar-link subtab_link' data-slug='%s' href='#%s' title='%s' >%s</a>", wp_kses_post( $link_id ), wp_kses_post( $div_id ), wp_kses_post( $link_id ), wp_kses_post( $section->name ), wp_kses_post( $section->name ) ) . '</li>' );
											}
										}
										$this->save_button();
										?>
        ...
        <li class='top-level general save-button'>
            <div class="navsave">
                <input type="submit" class="button-primary"
                       value="<?php echo wp_kses( $this->save_text, 'strip' ); ?>"/>
            </div>
        </li>
		<?php
	}
