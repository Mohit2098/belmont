                    ...
                    <table class="comparison-table" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (!empty($rowcount)) : ?>
                                <tr>
                                    <td class="gray-bg-td" colspan="<?php echo $rowcount + 1; ?>"><?php _e('Trailers Specifications', 'btrailers-theme'); ?></td>
                                </tr>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($rowcount)) : ?>
                                <tr>
                                    <td class="gray-lt-bg-td" colspan="<?php echo $rowcount + 1; ?>"><?php _e('Trailer Attribute', 'btrailers-theme'); ?></td>
                                </tr>
                            <?php endif;
                            ...
                            <?php if (!empty($rowcount)) : ?>
                                <tr>
                                    <td class="gray-lt-bg-td" colspan="<?php echo $rowcount + 1; ?>"><?php _e('Standard Features', 'btrailers-theme'); ?></td>
                                </tr>
                            <?php endif;
                            ...
                            <?php if (!empty($rowcount)) : ?>
                                <tr>
                                    <td class="gray-lt-bg-td" colspan="<?php echo $rowcount + 1; ?>"><?php _e('Additional Options', 'btrailers-theme'); ?></td>
                                </tr>
                            <?php endif;
