<section class="bl-section flattrak-testimonial">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <?php $flattrak_testimonial_logo = get_sub_field('flattrak_testimonial_logo');
                if (!empty($flattrak_testimonial_logo)) : ?>
            ...
            <?php if (have_rows('flattrak_testimonial_content')) : ?>
                <div class="col-12 testimonial-slider">
                    <?php while (have_rows('flattrak_testimonial_content')) : the_row();
