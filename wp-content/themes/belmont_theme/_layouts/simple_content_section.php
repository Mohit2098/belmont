...
?>
<section class="simple-content-section pt-70 pb-70 <?php echo $select_section_width; ?> <?php echo $select_heading_type; ?><?php echo (!empty($upload_logo))? ' simple-content-w-logo' : ''; ?>" id="<?php echo ($additional_section_id != '')? $additional_section_id : ''; ?>">
    <div class="container">
        <div class="content-inner">
            <div class="heading-logo-wrap">
            <?php if($section_heading != '' && $select_heading_type == "main-heading"): ?><h1><?php echo $section_heading; ?></h1>
            <?php elseif($section_heading != '' && $select_heading_type == "small-heading"): ?><h2 class="h3"><?php echo $section_heading; ?></h2><?php endif; ?>
