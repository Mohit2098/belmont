...
?>
<div class="simple-content-section <?php echo $select_section_width; ?>">
<?php if($section_heading != '' || $upload_logo != '' ): ?><div class="heading-logo-wrap"><?php endif; ?>
    <?php if($section_heading != ''): ?><h2 class="<?php echo $select_heading_type; ?>"><?php echo $section_heading; ?></h2><?php endif; ?>
